...
abstract final class MockVoice {
  ...
  static const leaderboardShareRankLine =
      " I just ranked among mock.edumimi's top students.";

  static const logOutTitle = 'Log out?';
  static const logOutDesc =
      'You can log back in anytime to continue where you stopped.';
  ...
  static const removeAvatarDesc =
      'Your initials will show on your profile instead.';
  static const removeAvatarConfirm = 'Remove';

  static const redeemLicenseTitle = 'Redeem license?';
  static const redeemLicenseDesc =
      'This will add the school license to your account.';
  static const redeemLicenseConfirm = 'Redeem code';

  static const cancelPaymentTitle = 'Cancel payment?';
  static const cancelPaymentDesc =
      'You can return to packages and complete checkout later.';
  ...
  static const transactionPinPromptBody =
      'Confirm your 4–6 digit PIN to continue to secure checkout.';
  ...
  static const transactionPinSectionBody =
      'Use a 4–6 digit PIN to authorize package payments securely.';
  ...
  static const onboardingPages = [
    MockOnboardingPage(
      ...
      body:
          'Run a free mock in minutes. JAMB, WAEC, NECO and scholarship drills stay free to try.',
    ),
    MockOnboardingPage(
      iconName: 'wifi_off_outlined',
      title: 'Works offline',
      body:
          'Download practice questions and keep studying when your connection drops.',
    ),
    MockOnboardingPage(
      iconName: 'bar_chart_outlined',
      title: 'Track your progress',
      body:
          'Check your scores, spot weak topics, and see how you improve over time.',
    ),
    MockOnboardingPage(
      iconName: 'emoji_events_outlined',
      title: 'Climb the rankings',
      body:
          'Submit full exams, join the top students list, and share wins with your study squad.',
    ),
  ];
  ...
  static String formatLeaderboardDate(String submittedAt) {
    return MockDateTime.date(submittedAt);
  }
}
